package br.com.luan.barcella.rick.and.morty.manage.dto.response;

import static br.com.luan.barcella.rick.and.morty.manage.domain.Message.FALHA_INESPERADA;
...
import br.com.luan.barcella.rick.and.morty.manage.exception.AbstractErrorException;
import br.com.luan.barcella.rick.and.morty.manage.exception.ClientErrorException;
...
public final class ErrorResponse implements Serializable {
    ...
    public static ErrorResponse buildDefault() {
        return ErrorResponse.builder().errorType(ErrorType.INTERNAL_ERROR).message(
            FALHA_INESPERADA.name().replace("_", " ")).build();
    }
